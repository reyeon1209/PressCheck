...
for rss in donga_url:
  if rss == None:
    ...
    for p in parse_rss.entries:
      ...
      upload_date = soup.find('div',class_='title_foot').select("date01")
      print(uploaded)
    
      #update_date = soup.find('div',class_='title_foot').select("date01")[2]
      #updated = update_date.text
      #print(updated)
        
      #editor = soup.find('div',class_='title_foot').select("date01")[0].text
      #print(editor)
