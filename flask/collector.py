...
pl = ['한겨레','중앙','동아','KBS','SBS','국민','연합']           #press list
    ...
    for rss in joongang_url:
        if rss == None:
            ...
            for index,p in enumerate(parse_rss.entries):
                ...
                dup=False
                for article in collection.find({'press' :'중앙' ,'category':cl[i]},{'link':1}):
                ...
                joongang_dic.append({'title':p.title,'link':p.link,'press':'중앙','category':cl[i],'uploaded':uploaded,'updated':updated,'editor':editor,'img_src':img_src,'content':description,'pre_content':cleaned_sentence,'keyword':'\0','sum_short':'\0','sum_mid':'\0','sum_long':'\0'})
    ...
    for rss in donga_url:
        if rss == None:
            ...
            for index,p in enumerate(parse_rss.entries):
                  ...
                  dup=False
                  for article in collection.find({'press' :'동아' ,'category':cl[i]},{'link':1}):
                    if pagelink==list(article.values())[1]:
                        dup=True
                        break
                  if dup is True:
                  ...
                  donga_dic.append({'title':p.title,'link':p.link,'press':'동아','category':cl[i],'uploaded':uploaded,'updated':updated,'editor':editor,'img_src':img_src,'content':description,'pre_content':cleaned_sentence,'keyword':'\0','sum_short':'\0','sum_mid':'\0','sum_long':'\0'})
    ...
    for rss in kbs_url:
      if rss == None:
        ...
        for index,p in enumerate(parse_rss.entries):
          ...
          dup=False
          for article in collection.find({'press' :'kbs' ,'category':cl[i]},{'link':1}):
            if pagelink==list(article.values())[1]:
                dup=True
                break
          if dup is True:
...
def collectSbs1():
    ...
    for index,p in enumerate(pages):
        if(index==20):
            break  
        dup=False
        for article in collection.find({'press' :'sbs' ,'category':'전체'},{'link':1}):
    ...
    sbs_dic.append({'title':news_title.text,'link':p,'press':'sbs','category':'전체','uploaded':uploaded,'updated':updated,'editor':editor,'img_src':img_src,'content':description,'pre_content':cleaned_sentence,'keyword':'\0','sum_short':'\0','sum_mid':'\0','sum_long':'\0'})
    ...
    for rss in sbs_url:
      if rss == None:
        ...
        for index,p in enumerate(parse_rss.entries):
          ...
          dup=False
          for article in collection.find({'press' :'sbs' ,'category':cl[i]},{'link':1}):
            if p==list(article.values())[1]:
                dup=True
                break
            if dup is True:
          ...
          sbs_else.append({'title':news_title,'link':p.link,'press':'sbs','category':cl[i],'uploaded':uploaded,'updated':updated,'editor':editor,'img_src':img_src,'content':description,'pre_content':cleaned_sentence,'keyword':'\0','sum_short':'\0','sum_mid':'\0','sum_long':'\0'})
    ...
    for rss in kmib_url:
        if rss == None:
            ...
            for index,p in enumerate(parse_rss.entries):
                ...
                dup=False
                for article in collection.find({'press' :'국민' ,'category':cl[i]},{'link':1}):
                  if pagelink==list(article.values())[1]:
                    dup=True
                    break
                if dup is True:
    ...
    for rss in yonhap_url:
      if rss == None:
        ...
        for index,p in enumerate(parse_rss.entries):
          ...
          dup=False
          for article in collection.find({'press' :'연합' ,'category':cl[i]},{'link':1}):
            if pagelink==list(article.values())[1]:
                dup=True
                break
          if dup is True:
          ...
          yonhap_dic.append({'title':news_title,'link':p.link,'press':'연합','category':cl[i],'uploaded':uploaded,'updated':updated,'editor':editor,'img_src':img_src,'content':description,'pre_content':cleaned_sentence,'keyword':'\0','sum_short':'\0','sum_mid':'\0','sum_long':'\0'})
    ...
    for rss in hani_url:
      if rss == None:
        ...
        for index,p in enmuerate(parse_rss.entries):
          ...
          dup=False
          for article in collection.find({'press' :'한겨레' ,'category':cl[i]},{'link':1}):
            if pagelink==list(article.values())[1]:
                dup=True
                break
          if dup is True:
          ...
          hani_dic.append({'title':news_title,'link':pagelink,'press':'한겨레','category':cl[i],'uploaded':uploaded,'updated':updated,'editor':editor,'img_src':img_src,'content':description,'pre_content':cleaned_sentence,'keyword':'\0','sum_short':'\0','sum_mid':'\0','sum_long':'\0'})
