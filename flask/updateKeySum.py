...
def insert_summary():
    ...
    client = pymongo.MongoClient("mongodb+srv://han:qpdlf52425@cluster0.kz4b2.mongodb.net/collectTest?retryWrites=true&w=majority")
    db = client.get_database('collectTest') 
    collection = db.test5
...
def insert_keyword():
    ...
    stop_words = ['이', '있', '하', '것', '들', '그', '되', '수', '이', '보', '않', '없', '나', '사람', '주',
             ...
             '제대로', '관', '지난', '비준', '지난해', '위해','곳곳', '현재', '당일', '주요', '일대', 
              ...
              '섯알',  '가운데','보이' ,'것처', '해도' ,'대부분' ,'섯알' ,'먼저', '노', '해당', '거' ,'올레', '가가',
