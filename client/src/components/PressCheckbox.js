...
function PressCheckbox( props ) {
    ...
    return (
        <li>
            <input key={props.id} onClick={props.handleCheckChieldElement} type="checkbox" onChange={props.handleCheckChange} value={props.value} /> <img src={pressComponent} />
        </li>
    )
}

export default PressCheckbox